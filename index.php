            ...
            <?php if (!empty($products)): ?>
                <?php foreach ($products as $product): ?>
                    <div class="product-card">
                        ...
                        // Debug: cek apakah file exists
                        echo "<!-- Debug: " . $image_url . " -->";
                        echo "<!-- File exists: " . (file_exists($full_path) ? 'YES' : 'NO') . " -->";
                        
                        // Jika gambar tidak ada, gunakan placeholder
                        if (empty($image_url) || !file_exists($full_path)) {
                            $image_url = 'https://via.placeholder.com/300x200/cccccc/333333?text=' . urlencode($product['name']);
                        }
                        ?>
    ...
    <div class="container">
        <div class="about-content">
            <div class="about-text">
                ...
                <p>Dengan pengalaman lebih dari 5 tahun di industri audio, kami memahami kebutuhan akan kualitas suara yang jernih, detail, dan akurat.</p>
                <p>Semua produk kami melalui proses quality control yang ketat untuk memastikan kepuasan pelanggan.</p>
            </div>
            <div class="about-image">
                <img src="https://via.placeholder.com/500x300/cccccc/333333?text=About+Premium+IEM" 
                     alt="Tentang Premium IEM">
            </div>
        </div>
    </div>
</section>
